...
7. Browse to the Swagger documentation at `https://{github-username}.github.io/{repository-name}/`.
   ...
   The example API specification used by this repository can be seen hosted at [https://nagarajuv-jfrog.github.io/swagger-github-pages](https://nagarajuv-jfrog.github.io/swagger-github-pages).
